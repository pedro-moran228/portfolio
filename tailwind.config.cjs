  ...
  plugins: [
    function ({ addComponents }) {
      addComponents({
        ...
        ".marker": { "@apply relative before:absolute before:-left-3.5 before:top-[13px] before:-translate-y-1/2 before:h-2 before:w-2 before:bg-secondary before:brightness-125 before:rounded": {} },
